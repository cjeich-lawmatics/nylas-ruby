...
module NylasV5
  ...
  class CalendarCollection < Collection
    ...
    # @param free_busy [Array<NylasV5::FreeBusy>] A list of free-busy data for users not in your organization
    # @param open_hours [Array<NylasV5::OpenHours>] Additional times email accounts are available
