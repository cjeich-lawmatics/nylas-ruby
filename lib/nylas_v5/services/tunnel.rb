...
module NylasV5
  ...
  class Tunnel
    ...
    #
    # @param api [NylasV5::API] The configured Nylas API client
    ...
    # @return [NylasV5::Webhook] The webhook details response from the API
    ...
    # @return [NylasV5::Delta] The delta object
